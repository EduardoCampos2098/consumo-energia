...
# Saída
print (f"O {eletrodoméstico} cria um consumo mensal de, aproximadamente,{consumo_elétrico_mensal: .0f} kWh. Que ao final do mês tem como total aproximado{cálculo_monetário: .2f} R$.")